...
@REM
@REM Modified: BCV solutions, see CHANGELOG.md
...
set CP=%CP%;lib\jackson-core-2.9.8.jar
set CP=%CP%;lib\jackson-databind-2.9.8
set CP=%CP%;lib\jackson-annotations-2.9.8.jar
echo %CP%
...
rem Run java options, separated by space "-Dlogback.configurationFile=lib\logback.xml"
set JAVA_OPTS=-Xmx500m "-Djava.util.logging.config.file=conf\logging.properties" "-Xdebug" "-Xrunjdwp:transport=dt_socket,address=5005,server=y,suspend=n"
